...
#define FLX_STRUCT_TYPE_UNKNOWN  0
#define FLX_STRUCT_TYPE_TEXT  1
#define FLX_STRUCT_TYPE_GLOBAL_ENUM  2
#define FLX_STRUCT_TYPE_INTEGER  3
#define FLX_STRUCT_TYPE_FLOAT  4
#define FLX_STRUCT_TYPE_LOGIC  5
#define FLX_STRUCT_TYPE_BINARY  6
#define FLX_STRUCT_TYPE_LOCAL_ENUM  7
#define FLX_STRUCT_TYPE_MERGE_ENUM  8
#define FLX_STRUCT_TYPE_STRUCT  9
#define FLX_STRUCT_TYPE_ENUM_ARRAY  10
#define FLX_STRUCT_TYPE_INTEGER_ARRAY  11
#define FLX_STRUCT_TYPE_FLOAT_ARRAY  12
#define FLX_STRUCT_TYPE_TEXT_ARRAY  13

#define FLX_STRUCT_MOD_VALID_UNTIL_CHANGE 0x40
#define FLX_STRUCT_MOD_HIDDEN  0x80;

#define FLX_STRUCT_MASK_TYPE 0x0f
#define FLX_STRUCT_MASK_XDF 0x30
#define FLX_STRUCT_MASK_MOD 0xc0

#define FLX_STRUCT_TYPE_MOD_HIDDEN  0x80

#define FLX_ENUM_GLOBAL  0
#define FLX_ENUM_RELATION_TARGET  1
#define FLX_ENUM_RELATION_STYLE  2
#define FLX_ENUM_LABEL_STYLE  3
#define FLX_ENUM_RELATION_DOMAINBASE  2
#define FLX_ENUM_MEMBER_0  8

#define FLX_AT_ASSOC_DELTA 0
#define FLX_AT_ASSOC_DELTA_REV 1
#define FLX_AT_ASSOC_POS 2
#define FLX_AT_ASSOC_POS_REV 3
...
typedef flxresult (*flxBufferAccess)(flxbyte command, void* buffer, flxbint* len, flxbyte** bytes);
typedef flxresult (*flxBufferHandle)(flxbyte command, void* buffer, flxbint* len, flxbyte* bytes, void *user);
typedef flxresult (*flxBufferInit)(flxbyte command, void* buffer, struct flxTraceStruct *trace);
 ...
 * @return Returns FLX_OK is succeeded, or FLX_ERROR_ in the error case
 */
flxresult flxInitMember(flxMemberValue member, flxuint memberId, flxtext label, flxbyte memberType,
 ...
 * @return Returns FLX_OK is succeeded, or FLX_ERROR_ in the error case
 */
flxresult flxWriteRelation(flxTrace trace, flxid itemId, flxbyte type, flxuint target, flxuint style,
	flxsdelta deltaOrPosition, flxuint targetBase);
/**

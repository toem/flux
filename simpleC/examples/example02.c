...
flxresult myHandler(flxbyte command, void* buffer, flxbint* len, flxbyte* bytes, void*user) {
...
void example02() {
	...
	// buffer
	flxBuffer buffer = flxCreateSimpleBuffer(memoryBuffer, bufferSize, myHandler, 0);

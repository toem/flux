...
void example10() {
	...
	// output file
	FILE *out = fopen("traces/example10.recTr", "wb");
	...
	// buffers
	flxBuffer buffer1 = flxCreateSimpleBuffer(memoryBuffer, bufferSize, flxWriteToFile, out); // writes to files
	...
	if (trace != 0) {
		...
		for (int n = 0; n < 50000; n++) {
			...
			flxWriteLogicTextAt(trace, 23, 0, 0, 1, 0, "0011x1", 6, 1);

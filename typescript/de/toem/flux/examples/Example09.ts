...
export class Example09 {
    ...
    public static example() {
        ...
        let buffer : Flx.Buffer = new SimpleFileOutputBuffer(Example09.MAX_ENTRY_SIZE, "traces/example09.recTr");
        let trace : Flx.Trace = new Flx.Trace(0, Example09.MAX_ITEM_ID, Example09.MAX_ENTRY_SIZE, false, buffer);
        if (trace != null){
            ...
            let innermembers : Flx.MemberValue[] = trace.createMembers(10);
            ...
            let innerinnermembers : Flx.MemberValue[] = trace.createMembers(3);
